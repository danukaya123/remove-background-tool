...
async function removeBackground(){
    ...
    const data = Float32Array.from(imageData.data).filter((v,i) => i%4 !== 3).map(v => v/255.0); // remove alpha
    ...
    const maskData = results.output.data; // float32 0-1
    ...
    // Composite original image with mask
